...
- When the reader profile lists secondary goals, organize around the primary goal and serve secondaries as consequences of that throughline (worked examples, layouts, checklists, success criteria) — do not drop them and do not give each equal top-level weight.
