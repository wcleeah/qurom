...
.new-run-form-busy .document-compose-textarea,
.new-run-form-busy .new-run-textarea,
.new-run-form-busy .form-input:not([type="hidden"]) {
  opacity: 0.65;
  pointer-events: none;
}
.new-run-form-busy .btn-primary.is-loading {
  cursor: wait;
  opacity: 0.9;
}
.new-run-active-note {
...
.app-navbar-section-menu {
  display: none;
  position: relative;
  flex-shrink: 0;
}
.app-navbar-section-toggle {
  display: inline-flex;
  align-items: center;
  gap: 0.3rem;
  padding: 0.28rem 0.5rem;
...
.app-navbar-section-chevron {
  font-size: 0.65rem;
  color: var(--muted);
  line-height: 1;
}
.app-navbar-section-panel {
  display: none;
  position: absolute;
  left: 0;
...
.app-navbar-overflow-toggle:hover {
  border-color: var(--accent);
  color: var(--accent);
}
.app-navbar-overflow-panel {
  display: flex;
  align-items: center;
  gap: 0.45rem;
}
.app-navbar-action:disabled {
  opacity: 0.45;
  cursor: not-allowed;
}
...
.app-navbar-action-icon svg {
  display: block;
  width: 1rem;
  height: 1rem;
}
.app-navbar-action-label {
  display: inline;
}
.app-navbar-section-menu[data-nav-menu-open] .app-navbar-section-panel {
  display: flex;
}
...
.node-work-panel:last-child {
  margin-bottom: 0;
}
.node-work-panel-header {
  display: flex;
  flex-wrap: wrap;
  align-items: baseline;
  gap: 0.5rem 0.75rem;
...
.node-work-panel-header h3 {
  margin: 0;
  font-size: 1rem;
}
.draft-preview-details summary,
.design-preview-details summary {
  cursor: pointer;
  font-weight: 600;
  font-size: 0.85rem;
  margin-bottom: 0.5rem;
...
.interview-turn-panel .chat-transcript {
  display: flex;
  flex-direction: column;
  gap: 0.65rem;
}
...
.design-history-details summary {
  cursor: pointer;
  font-weight: 600;
  font-size: 0.85rem;
  margin-bottom: 0.5rem;
