...
3. When drafts contradict on a factual claim, resolve it by source quality. If unresolvable, note the contradiction explicitly with a brief note.
4. Preserve the deep-dive contract in full: source-backed reasoning, closure bar, artifact guidance, output rules.
