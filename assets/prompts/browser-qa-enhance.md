...
The HTML content to inspect is provided in the `HTML document` context. Write to a local file first, make sure you write it by chunk, instead of one full write.
