...
describe("html ask routes and ui", () => {
  ...
  test("renders Ask tab UI with flat chat list", () => {
    ...
    expect(html).toContain("applyThreadBootstrap")
    expect(html).toContain('aria-current="true"')
    expect(html).toContain("html-viewer-ask-chat-selected")
    expect(html).toContain("startNewChat()")
    expect(html).toContain('detail.selection')
    expect(html).toContain('detail.highlightId')
    expect(html).toContain('detail.forceNew')
