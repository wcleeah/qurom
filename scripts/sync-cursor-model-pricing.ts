...
const PRICING_ROWS: PricingRow[] = [
  { name: "Grok 4.7", href: "/docs/models/grok-4-7", input: 2, cacheWrite: null, cacheRead: 0.5, output: 6 },
  { name: "Grok 4.7 (Fast)", href: "/docs/models/grok-4-7", input: 4, cacheWrite: null, cacheRead: 1, output: 12, variantKey: "grok-4.7-fast" },
  { name: "Grok 4.7 500k", href: "/docs/models/grok-4-7", input: 4, cacheWrite: null, cacheRead: 1, output: 12, variantKey: "grok-4.7-500k" },
  { name: "Grok 4.7 500k (Fast)", href: "/docs/models/grok-4-7", input: 6, cacheWrite: null, cacheRead: 1.5, output: 18, variantKey: "grok-4.7-500k-fast" },
  { name: "Grok 4.6", href: "/docs/models/grok-4-6", input: 2, cacheWrite: null, cacheRead: 0.5, output: 6 },
  { name: "Grok 4.6 (Fast)", href: "/docs/models/grok-4-6", input: 4, cacheWrite: null, cacheRead: 1, output: 12, variantKey: "grok-4.6-fast" },
  { name: "Grok 4.5", href: "/docs/models/grok-4-5", input: 2, cacheWrite: null, cacheRead: 0.5, output: 6 },
  { name: "Grok 4.5 (Fast)", href: "/docs/models/grok-4-5", input: 4, cacheWrite: null, cacheRead: 1, output: 18, variantKey: "grok-4.5-fast" },
  ...
  { name: "Claude Fable 5.1", href: "/docs/models/claude-fable-5-1", input: 10, cacheWrite: 12.5, cacheRead: 0.25, output: 50 },
  ...
  { name: "Claude Opus 5", href: "/docs/models/claude-opus-5", input: 5, cacheWrite: 6.25, cacheRead: 0.5, output: 25 },
  { name: "Claude Opus 5.5", href: "/docs/models/claude-opus-5-5", input: 4, cacheWrite: 5, cacheRead: 0.2, output: 20 },
  { name: "Claude Sonnet 5", href: "/docs/models/claude-sonnet-5", input: 2, cacheWrite: 2.5, cacheRead: 0.2, output: 10 },
  ...
  { name: "Gemini 3.6 Flash", href: "/docs/models/gemini-3-6-flash", input: 1.5, cacheWrite: null, cacheRead: 0.15, output: 7.5 },
  { name: "Gemini 3.7 Flash", href: "/docs/models/gemini-3-7-flash", input: 0.75, cacheWrite: null, cacheRead: 0.075, output: 3.5 },
  { name: "Gemini 3.8 Flash", href: "/docs/models/gemini-3-8-flash", input: 0.75, cacheWrite: null, cacheRead: 0.075, output: 3.5 },
  ...
  { name: "GPT-5.6 Luna", href: "/docs/models/gpt-5-6-luna", input: 0.2, cacheWrite: 0.25, cacheRead: 0.02, output: 1.2 },
  { name: "GPT-5.6 Sol", href: "/docs/models/gpt-5-6-sol", input: 4, cacheWrite: 5, cacheRead: 0.4, output: 20 },
  { name: "GPT-5.6 Terra", href: "/docs/models/gpt-5-6-terra", input: 2, cacheWrite: 2.5, cacheRead: 0.2, output: 12 },
  { name: "Kimi K2.7 Code", href: "/docs/models/kimi-k2-7-code", input: 0.95, cacheWrite: null, cacheRead: 0.19, output: 4 },
  { name: "Kimi K3", href: "/docs/models/kimi-k3", input: 3, cacheWrite: null, cacheRead: 0.3, output: 15 },
  { name: "Muse Spark 1.3", href: "/docs/models/muse-spark-1-3", input: 1.25, cacheWrite: null, cacheRead: 0.15, output: 4.25 },
]
...
const AUTO_PRICING = {
  ...
  note: "Auto bills at the list price of the routed model. This fallback is used only when the routed model is unknown.",
}
