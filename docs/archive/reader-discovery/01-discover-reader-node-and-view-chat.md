...
- **Phase:** 1
- **Source plan:** `docs/archive/reader-discovery/README.md` (Phase 1 section, Decisions A2/B1/C/D2, "How the interviewer outputs questions", "Where the chat lives", "The interviewer's JSON output goes through the recovery router")
