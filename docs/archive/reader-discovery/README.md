...
> **Status: phases 1–2 implemented** (`discoverReaderPrompt` / `discoverReaderResume` in `src/graph.ts`, view-server interview UI). Phases 3–4 (profile surfacing, adaptive upgrades) remain open.
> Companion to the recovery-router plan in `docs/archive/recovery-router/`.
...
- `docs/archive/recovery-router/` — phase-brief format this plan follows.
