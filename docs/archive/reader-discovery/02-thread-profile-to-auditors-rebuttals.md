...
- **Phase:** 2
- **Source plan:** `docs/archive/reader-discovery/README.md` (Phase 2 section, "Recommended approach")
...
- Source plan: `docs/archive/reader-discovery/README.md` — Phase 2 section, risk #7 ("Profile makes auditors too lenient").
