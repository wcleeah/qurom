...
- **Phase:** 4 (optional)
- **Source plan:** `docs/archive/reader-discovery/README.md` (Phase 4 section)
...
- Source plan: `docs/archive/reader-discovery/README.md` — Phase 4 section, risk #1 (wandering), risk #2 (abandonment).
