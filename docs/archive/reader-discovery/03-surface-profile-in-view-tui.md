...
- **Phase:** 3
- **Source plan:** `docs/archive/reader-discovery/README.md` (Phase 3 section, "Where the chat lives", UI sketch)
...
- Source plan: `docs/archive/reader-discovery/README.md` — Phase 3 section, "Where the chat lives" (the chat card is Phase 1; the profile card is Phase 3), UI sketch.
