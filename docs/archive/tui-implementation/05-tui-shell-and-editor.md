...
Source plan: `docs/archive/tui-implementation/README.md` §10 Step 5.
...
- `docs/archive/tui-implementation/README.md` §10 Step 5, §3 (constraints), §12 (renderer.suspend risk), §13 (editor tests).
