...
Source plan: `docs/archive/tui-implementation/README.md` §10 Step 8, §11 (footer hints), §12 (Ctrl-C mitigation).
...
- `docs/archive/tui-implementation/README.md` §10 Step 8 (focus + scroll + global keys), §11 (footer hints), §12 (Ctrl-C mitigation, `j/k` ambiguity mitigation).
