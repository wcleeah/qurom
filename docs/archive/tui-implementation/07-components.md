...
Source plan: `docs/archive/tui-implementation/README.md` §10 Step 7, §11 (UI sketch + component map).
...
- `docs/archive/tui-implementation/README.md` §10 Step 7, §11 (UI mocks + component map + state ownership + responsive behaviour), §12 (drafter slot for variable N, "too small" mitigation).
