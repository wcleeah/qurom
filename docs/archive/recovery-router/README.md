...
> **Status: completed.** Shipped in `src/opencode.ts`, `src/agent-runtime/structured-output.ts`, and related tests. User-facing summary lives in the root `README.md` § Recovery & Telemetry.
...
Start a topic run from the dashboard with: `highlighting text in html, across tags and anchors. hicups and how does it work, how does the browser handles it`
